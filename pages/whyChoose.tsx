...
const WhyChoose: NextPage = () => {
    return (
        <section className="whyChoose bg-light-gray-blue w-full py-[6.4rem] px-[2.4rem] lg:px-[16.5rem] lg:py-[9.6rem] text-center lg:text-left">
            ...
            <div className="whychoose__content lg:flex w-[32.7rem] m-auto lg:w-full lg:m-0 xl:justify-between">
                <div>
                    ...
                    <span className="whychoose__content--text block text-gray-blue font-normal text-[1.5rem] tracking-tight leading-[2.5rem] mb-[3.2rem] lg:text-base lg:leading-[2.6rem] lg:tracking-tight lg:w-[23rem] lg:mr-[5.5rem]">
                ...
                <div>
                    ...
                    <span className="whychoose__content--text block text-gray-blue font-normal text-[1.5rem] tracking-tight leading-[2.5rem] mb-[3.2rem] lg:text-base lg:leading-[2.6rem] lg:tracking-tight lg:w-[25.5rem]">
