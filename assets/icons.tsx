...
export const Facebook = ({ fill, className }: classProps) => {
    return (
        <svg
            className={className}
...
export const Youtube = ({ fill, className }: classProps) => {
    return (
        <svg
            className={className}
            xmlns="http://www.w3.org/2000/svg"
...
export const Twitter = ({ fill, className }: classProps) => {
    return (
        <svg
            className={className}
            xmlns="http://www.w3.org/2000/svg"
...
export const Pinterest = ({ fill, className }: classProps) => {
    return (
        <svg
            className={className}
            xmlns="http://www.w3.org/2000/svg"
...
export const Instagram = ({ fill, className }: classProps) => {
    return (
        <svg
            className={className}
            xmlns="http://www.w3.org/2000/svg"
